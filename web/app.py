...
def get_messages():
    ...
    for i in rows:
        escaped_message = escape(i[0])
        message_string = str(escaped_message)
        messages_list.append(message_string)

    return render_template('main.html',messages_list = messages_list)
